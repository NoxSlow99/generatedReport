...
public class SpringBootJasperApplication {
	...
	CommandLineRunner init() {
		return args -> {
			...
			parameters.put("voucher_id", "0000054321");
			parameters.put("current_date", formatter.format(localDateTime));
			parameters.put("AmountPaid", new BigDecimal(1500));
			parameters.put("payment_method", "Cash");
			parameters.put("parent_name", "Laura E. Canche Angulo");
			parameters.put("child_name", "Angel J. Colli Canche");
